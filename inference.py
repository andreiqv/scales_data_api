...
def inference(image, shape):
	...
	#y1 = tf.placeholder(tf.float32, [None, NUM_CLASSES], name='Placeholder-y')   # Placeholder for labels.
	input_bottleneck = tf.reshape(x1, [-1, bottleneck_tensor_size])
